...
module.exports = [ 'curried', function (curried) {
  ...
  return {
    ...
    and: curried(foldl)(Nodash.AND, true),

    or: curried(foldl)(Nodash.OR, false),

    sum: curried(foldl)(Nodash.ADD, 0),

    product: curried(foldl)(Nodash.MUL, 1),

    maximum: curried(foldl)(Nodash.max, -Infinity),

    minimum: curried(foldl)(Nodash.min, +Infinity),
